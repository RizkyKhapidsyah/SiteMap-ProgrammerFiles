...
function loadtoc(a) {
	...
	document.write('</br><a href="https://programmerfiles.blogspot.com" style="font-size: 10px; text-decoration:none; color: #616469;"> Created by Rizky Khapidsyah </a>')
}
	...
	function displayToc2() {
		...
		while (b < postTitle.length) {
			...
			do {document.write("<li>");
				...
				if (postBaru[a] == true) {
					document.write(' - <strong><em><span style="color: rgb(255, 0, 0);">Baru!</span></em></strong>')
				}
	...
	function showToc() {
		if (tocLoaded) {
			...
			alert("Mohon Menunggu.. TOC sedang dimuat..")
		}
	}
	...
	function looptemp2() {
		for (var a = 0; a < numberfeed; a++) {
			...
			document.write('Download mp3  : <a href="'+postMp3[a]+'">'+postTitle[a]+"</a><br>");document.write("<br>")
		}
	};
